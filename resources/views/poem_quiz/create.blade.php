    ...
    <div class="container">
        <div class="row justify-content-center">  
            <div class = "col-md-10 text-center">
                <h4>Add Poem Quiz <a href = "{{ route('poem_quiz.index') }}" class = "btn btn-sm btn-info float-right">View Poem Quizzes</a></h4>
        ...
        <div class = "row justify-content-center">
            <div class = "col-md-6">
                <form action = "{{ route('poem_quiz.store') }}" method = "post">
                    {{ csrf_field() }}
                    <div class="form-group">
                        ...
                        <select name="chapter_id" class="form-control" required>
                            ...
                            <option value="{{ $poem->id }}">{{ $poem->chapter_name }}</option>
                            @endforeach
                        </select>
                    </div>
